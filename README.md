...
6. **Проект первого модуля обучения:**
   - учебный проект "Анализ объявлений о продаже жилой недвижимости в Санкт-Петербурге и Ленинградской области": [ad hoc задачи с помощью SQL]() и [аналитическая записка]()
8. **Python (предобработка данных):**
   - 
9. Исследовательский анализ данных и визуализация с помощью Python
